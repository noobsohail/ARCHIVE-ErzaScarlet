...
from ErzaScarlet import MONGO_DB_URI
...
def load_module(shortname):
    if shortname.startswith("__"):
        ...
        import importlib
        import ErzaScarlet.events

        path = Path(f"ErzaScarlet/modules/{shortname}.py")
        name = "ErzaScarlet.modules.{}".format(shortname)
        ...
        mod.ErzaScarlet = ErzaScarlet
        mod.tbot = telethn
        mod.logger = logging.getLogger(shortname)
        spec.loader.exec_module(mod)
        sys.modules["ErzaScarlet.modules." + shortname] = mod
        print("Successfully imported " + shortname)


path = "ErzaScarlet/modules/*.py"
