...
from ErzaScarlet.modules.helper_funcs.extraction import extract_user_and_text
from ErzaScarlet.modules.helper_funcs.string_handling import extract_time
from ErzaScarlet.modules.log_channel import gloggable, loggable
...
@bot_admin
@can_restrict
def dragonkick(update: Update, context: CallbackContext):
...
__help__ = """
 ❍ /dragonkick*:* punchs the user who issued the command
...
DRAGONKICK_HANDLER = DisableAbleCommandHandler("dragonkick", dragonkick, filters=Filters.group)
...
dispatcher.add_handler(DRAGONKICK_HANDLER)
