...
from ErzaScarlet import API_ID, API_HASH, BOT_TOKEN, tbot, OWNER
    ...
    if "#request" in event.text:
      #  await asst.send_message(IN_GRP,
        ...
        btns = [
            ...
            [Button.url("💠 Channel 💠", url="https://t.me/indanimei"),
            Button.url("⚜️ Group ⚜️", url="https://t.me/indanimein")],
            [Button.url("📜 Index 📜", url="https://t.me/indianimeNetwork"),
            Button.url("Ecchi/Harem", url="https://t.me/Ecchi_harem")],
...
async def ans(e):
    await e.answer("This Request Is Completed... Checkout @indanimei 💖", alert=True, cache_time=0)
...
async def ans(e):
    await e.answer("This Request is unavailable... Ask Admins in @indanimein for help. 💞", alert=True, cache_time=0)
