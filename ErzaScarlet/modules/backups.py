...
import ErzaScarlet.modules.sql.notes_sql as sql
from ErzaScarlet import dispatcher, LOGGER, OWNER_ID, JOIN_LOGGER
from ErzaScarlet.__main__ import DATA_IMPORT
...
# from ErzaScarlet.modules.rules import get_rules
import ErzaScarlet.modules.sql.rules_sql as rulessql

# from ErzaScarlet.modules.sql import warns_sql as warnssql
import ErzaScarlet.modules.sql.blacklist_sql as blacklistsql
from ErzaScarlet.modules.sql import disable_sql as disabledsql

# from ErzaScarlet.modules.sql import cust_filters_sql as filtersql
# import ErzaScarlet.modules.sql.welcome_sql as welcsql
import ErzaScarlet.modules.sql.locks_sql as locksql
...
def export_data(update, context):
    ...
    f = open("ErzaScarlet{}.backup".format(chat_id), "w")
    ...
    context.bot.sendDocument(
        current_chat_id,
        document=open("ErzaScarlet{}.backup".format(chat_id), "rb"),
    ...
    os.remove("ErzaScarlet{}.backup".format(chat_id))  # Cleaning file
